...
namespace ferreteria_catalog.Services
{
    public interface IProductoService
    {
        ...
        Task<Response<IEnumerable<ProductoDTO>>> BuscarProductosPorTerminoYPaginacionAsync(string termino, int pagina, int cantidadPorPagina);
        Task<ProductoDTO> ObtenerProductoPorIdAsync(int id);
        Task ActualizarProductoAsync(ProductoDTO productoDto);
        Task ProcesarImagenes(List<string> imagenesNombre);
